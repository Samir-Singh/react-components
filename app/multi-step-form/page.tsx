...
const MultiStepForm = () => {
  ...
  return (
    <>
      ...
      <div className="p-5 max-w-screen flex flex-col justify-center items-center">
        <div className="lg:text-3xl text-xl font-semibold text-center">
          Join our Community of Developers
        </div>
        <div className="text-center mt-3 lg:text-sm text-xs">
          To join our community and participate in this challenges. Please fill
        ...
        {currentStep === 5 ? (
          <div
            ...
            className="bg-white rounded-xl lg:p-10 p-5 mt-10 flex flex-col items-center justify-center lg:w-lg"
          >
          ...
          <div
            style={{ boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }}
            className="bg-white rounded-xl lg:p-5 p-4 mt-10"
          >
            <Stepper
              primaryColor="#E96A49"
